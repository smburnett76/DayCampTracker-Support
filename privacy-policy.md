...
This policy applies to anyone who downloads and uses Day Camp Tracker from the Apple App Store. Day Camp Tracker is intended for **parents and guardians** managing household schedules. It is not directed at children to use on their own.

---

## 2. Information stored on your device

When you use Day Camp Tracker, you may enter and store the following **on your device only**:
...
**We do not receive, access, or store this schedule data on our servers** because Day Camp Tracker does not use a backend account or cloud database operated by us.
...
If you enable camp reminders, Day Camp Tracker schedules **local notifications** on your device (for example, one week before, the day before, and the morning a confirmed camp starts). These alerts are created and delivered by iOS on your phone; we do not send push notifications from our own servers.

You can turn reminders off in the app (Home → bell icon) or in **Settings → Notifications → Day Camp Tracker**.

### Location and addresses

Day Camp Tracker does **not** track your real-time GPS location.
...
When you tap **Open in Maps**, Day Camp Tracker opens your chosen maps app (Apple Maps, Google Maps, or Waze, if installed). Those apps handle data under their own policies.
...
Protect your device with a passcode or Face ID / Touch ID. Anyone who can unlock your phone can access data stored in Day Camp Tracker.
